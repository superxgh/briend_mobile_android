...
import 'package:briend_mobile_android/shared/shared.dart';
...
class CommonWidget {
  ...
  static EdgeInsets mainTBPadding({double width = 300}) {
    return EdgeInsets.fromLTRB(0.0, width * CommonConstants.paddingMain, 0.0,
        width * CommonConstants.paddingMain);
  }

  static EdgeInsets mainLRPadding({double width = 300}) {
    return EdgeInsets.fromLTRB(width * CommonConstants.paddingMain, 0.0,
        width * CommonConstants.paddingMain, 0.0);
  }

  static EdgeInsets mainCellTBPadding({double width = 300}) {
    return EdgeInsets.fromLTRB(0.0, width * CommonConstants.paddingCell, 0.0,
        width * CommonConstants.paddingCell);
  }

  static EdgeInsets mainCellLRPadding({double width = 300}) {
    return EdgeInsets.fromLTRB(width * CommonConstants.paddingCell, 0.0,
        width * CommonConstants.paddingCell, 0.0);
  }
  ...
  static Widget getLogoutIcon(
      {double? iconSize, required void Function()? onPressed}) {
    double iconSizeTmp = iconSize ?? 80.0;
    return IconButton(
        color: Colors.orange,
        iconSize: iconSizeTmp,
  ...
  static Widget getAppBranner({double? iconSize}) {
    ...
    return Row(
      children: [
        ...
        Text("SuperxPOS",
            style: TextStyle(
                fontSize: CommonConstants.topicText,
