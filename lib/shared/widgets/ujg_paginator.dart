...
import 'package:briend_mobile_android/shared/utils/common_widget.dart';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          UJGButton(text1: "<", backgroundColor: Colors.black, width: 30.0),
          UJGButton(
              text1: pageList[0].toString(),
              backgroundColor: Colors.black,
              width: 30.0),
          UJGButton(
              text1: pageList[1].toString(),
              backgroundColor: Colors.black,
              width: 30.0),
          UJGButton(
              text1: pageList[2].toString(),
              backgroundColor: Colors.black,
              width: 30.0),
          UJGButton(text1: ">", backgroundColor: Colors.black, width: 30.0),
          UJGButton(text1: ">|", backgroundColor: Colors.black, width: 30.0),
          UJGButton(
              text1: "Rows(10)", backgroundColor: Colors.black, width: 80.0)
        ],
      ),
    );
  }
